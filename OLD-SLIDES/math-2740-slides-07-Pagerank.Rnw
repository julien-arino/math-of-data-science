...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\titlepagewithfigure{FIGS-transitions/Gemini_Generated_Image_ssozssssozssssoz.jpeg}
\outlinepage{FIGS-transitions/Gemini_Generated_Image_2dtfd12dtfd12dtf.jpeg}
...
\newSectionSlide{FIGS-transitions/Gemini_Generated_Image_u239u0u239u0u239.jpeg}
...
\newSubSectionSlide{FIGS-transitions/Gemini_Generated_Image_u239u0u239u0u239.jpeg}
...
\newSubSectionSlide{FIGS-transitions/Gemini_Generated_Image_h927ggh927ggh927.jpeg}
...
\newSubSectionSlide{FIGS-transitions/Gemini_Generated_Image_4vlmzf4vlmzf4vlm.jpeg}
...
T[1,2] = 1 # First row only moves right
T[nb_states, (nb_states-1)] = 1 # Last row only moves left
@

\begin{frame}[fragile]\frametitle{Create the MC object}
<<>>=
# Library: markovchain
...
\newSubSectionSlide{FIGS-transitions/Gemini_Generated_Image_dzsfcndzsfcndzsf.jpeg}
...
# Total population
nb_states = 7
proba_left = 0.5  # Probability of moving left
proba_right = 0.5 # Probability of moving right
proba_stay = 1-(proba_left+proba_right)
# Make the transition matrix
T = mat.or.vec(nr = nb_states, nc = nb_states)
for (row in 2:(nb_states-1)) {
...
T[1,1] = 1 # First state is absorbing
T[nb_states, nb_states] = 1 # Last too
@
\end{frame}
...
\newSectionSlide{FIGS-transitions/Gemini_Generated_Image_cdlhu6cdlhu6cdlh.jpeg}
...
%%%%%%%%%%%%%%%%%%%%
\section{PageRank}
\newSectionSlide{FIGS-transitions/Gemini_Generated_Image_n8c43hn8c43hn8c4.jpeg}
