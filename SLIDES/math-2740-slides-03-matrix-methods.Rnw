...
\maxFrameImage{\Sexpr{knitr::fig_chunk("load-bmp-svd", "pdf")}}
...
plot(new_image)
write.pnm(new_image, file = "FIGS/matrix-methods-image-svd-n2-1.pgm")
@
\end{frame}

\begin{frame}\frametitle{Using $n=2$ singular values}
\begin{center}
\includegraphics[width=0.45\textwidth]{\Sexpr{knitr::fig_chunk("load-bmp-svd", "pdf")}}
\includegraphics[width=0.45\textwidth]{\Sexpr{knitr::fig_chunk("plot-image-svd-n2", "pdf")}}
\end{center}
\vfill
...
\begin{center}
\includegraphics[width=0.45\textwidth]{\Sexpr{knitr::fig_chunk("load-bmp-svd", "pdf")}}
\includegraphics[width=0.45\textwidth]{\Sexpr{knitr::fig_chunk("plot-image-svd-n2", "pgm")}}
\end{center}
\vfill
Uses \Sexpr{round(M_tmp$pct_of_original, 2)}\% of the original information
\end{frame}
...
\begin{center}
\includegraphics[width=0.45\textwidth]{\Sexpr{knitr::fig_chunk("load-bmp-svd", "pdf")}}
\includegraphics[width=0.45\textwidth]{\Sexpr{knitr::fig_chunk("plot-image-svd-n5", "pdf")}}
\end{center}
\vfill
Uses \Sexpr{round(M_tmp$pct_of_original, 2)}\% of the original information
\end{frame}
...
\begin{center}
\includegraphics[width=0.45\textwidth]{\Sexpr{knitr::fig_chunk("load-bmp-svd", "pdf")}}
\includegraphics[width=0.45\textwidth]{\Sexpr{knitr::fig_chunk("plot-image-svd-n10", "pdf")}}
\end{center}
\vfill
Uses \Sexpr{round(M_tmp$pct_of_original, 2)}\% of the original information
\end{frame}
...
\begin{center}
\includegraphics[width=0.45\textwidth]{\Sexpr{knitr::fig_chunk("load-bmp-svd", "pdf")}}
\includegraphics[width=0.45\textwidth]{\Sexpr{knitr::fig_chunk("plot-image-svd-n20", "pdf")}}
\end{center}
\vfill
Uses \Sexpr{round(M_tmp$pct_of_original, 2)}\% of the original information
\end{frame}
...
\begin{center}
\includegraphics[width=0.45\textwidth]{\Sexpr{knitr::fig_chunk("load-bmp-svd", "pdf")}}
\includegraphics[width=0.45\textwidth]{\Sexpr{knitr::fig_chunk("plot-image-svd-n50", "pdf")}}
\end{center}
\vfill
Uses \Sexpr{round(M_tmp$pct_of_original, 2)}\% of the original information
\end{frame}
