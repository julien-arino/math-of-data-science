...
\maxFrameImage{\Sexpr{knitr::fig_chunk("plot-image-svd-original", "pdf")}}

% \begin{frame}
% \centerline{%
% \XeTeXpicfile "\Sexpr{knitr::fig_chunk("plot-image-svd-original", "bmp")}" width 8cm
% }
% \end{frame}
...
\begin{center}
\includegraphics[width=0.45\textwidth]{\Sexpr{knitr::fig_chunk("plot-image-svd-original", "pdf")}}
