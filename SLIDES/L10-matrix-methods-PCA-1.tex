...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in file(file, "{}rt"{}): cannot open the connection to 'https://github.com/julien-arino/math-of-data-science/raw/refs/heads/main/DATA/hockey-players.csv'}}\begin{alltt}
...
\vfill
After deduplication, we have an $\times 2$ matrix (actually, $\times 4$ if we consider the uncentred and centred variables, but we will use one or the other, not both uncentred and centred)
\vfill
