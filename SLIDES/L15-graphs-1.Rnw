...
\maxFrameImage{\Sexpr{knitr::fig_chunk("setup-graph-3", "pdf")}}
...
<<better-plot-Zachary-graph, fig.width=9, fig.height=7, dev='cairo_pdf'>>=
...
\maxFrameImage{\Sexpr{knitr::fig_chunk("better-plot-Zachary-graph", "pdf")}}
...
<<Zachary-graph-igraph-plot-better,fig.width=8,fig.height=6>>=
...
\maxFrameImage{\Sexpr{knitr::fig_chunk("Zachary-graph-igraph-plot-better", "pdf")}}
...
\maxFrameImage{\Sexpr{knitr::fig_chunk("make-regular-graph", "pdf")}}
...
<<plot-two-isomorphic-graphs,echo=FALSE>>=
par(mfrow = c(1, 2))
plot(G1, main = TeX("Graph G$_1$"))
plot(G2, main = TeX("Graph G$_2$"))
par(mfrow = c(1, 1))
@

\maxFrameImage{\Sexpr{knitr::fig_chunk("plot-two-isomorphic-graphs", "pdf")}}
...
<<plot-union-combined, echo=FALSE, fig.width=12, fig.height=4, out.width="\\textwidth">>==
# Set the plot layout to 1 row and 3 columns
...
plot(net2, main = "net2")
# Plot 3
plot(net1 %u% net2, main = "Union (net1 %u% net2)")
# Reset layout to default (good practice)
par(mfrow = c(1, 1))
@

\maxFrameImage{\Sexpr{knitr::fig_chunk("plot-union-combined", "pdf")}}
...
<<plot-intersection-combined, echo=FALSE, fig.width=12, fig.height=4, out.width="\\textwidth">>==
par(mfrow = c(1, 3), mar = c(1, 1, 3, 1)) 
# Plot 1
plot(net1, main = "net1")
# Plot 2
plot(net2, main = "net2")
# Plot 3
plot(net1 %s% net2, main = "Intersection (net1 %u% net2)")
par(mfrow = c(1, 1))
@

\maxFrameImage{\Sexpr{knitr::fig_chunk("plot-intersection-combined", "pdf")}}
