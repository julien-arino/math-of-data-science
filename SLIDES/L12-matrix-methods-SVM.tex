...
\begin{alltt}
\hlkwd{set.seed}\hldef{(}\hlnum{2025}\hldef{)}
\hldef{tune.out} \hlkwb{=} \hlkwd{tune}\hldef{(svm, y} \hlopt{~} \hldef{.,} \hlkwc{data} \hldef{= dat,}
                \hlkwc{kernel} \hldef{=} \hlsng{'linear'}\hldef{,}
                \hlkwc{ranges} \hldef{=} \hlkwd{list}\hldef{(}\hlkwc{cost} \hldef{=} \hlkwd{c}\hldef{(}\hlnum{0.01}\hldef{,} \hlnum{0.1}\hldef{,} \hlnum{1}\hldef{,} \hlnum{10}\hldef{,} \hlnum{100}\hldef{)))}
