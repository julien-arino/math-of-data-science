...
\hldef{lambda} \hlkwb{<-} \hlnum{0.05}   \hlcom{# Regularization strength}
...
\hlkwa{for} \hldef{(t} \hlkwa{in} \hlnum{1}\hlopt{:}\hldef{epochs) \{}
    ...
    \hlkwa{if} \hldef{(}\hlkwd{any}\hldef{(active)) \{}
        \hldef{grad_w} \hlkwb{<-} \hlnum{2} \hlopt{*} \hldef{lambda} \hlopt{*} \hldef{w} \hlopt{-}
          \hlkwd{colSums}\hldef{( (Y[active]} \hlopt{*} \hldef{X[active, ,} \hlkwc{drop} \hldef{=} \hlnum{FALSE}\hldef{]) )} \hlopt{/} \hldef{n}
...
\hlkwd{cat}\hldef{(}\hlsng{"w:"}\hldef{,} \hlkwd{paste}\hldef{(}\hlkwd{round}\hldef{(w,} \hlnum{3}\hldef{),} \hlkwc{collapse} \hldef{=} \hlsng{", "}\hldef{),}
    \hlsng{" b:"}\hldef{,} \hlkwd{round}\hldef{(b,} \hlnum{3}\hldef{),} \hlsng{"\textbackslash{}n"}\hldef{)}
\end{alltt}
\begin{verbatim}
