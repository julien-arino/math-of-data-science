...
\begin{itemize}
\item "Numerical dates" are in the form YYYY-MM-DD (e.g, these slides were compiled on 2026-09-02)
\vfill
...
\begin{itemize}
\item 1 final examination during the December 2026 Examination period (\textbf{35\%})
\vfill
\item 1 midterm on Thursday 5 November 2026 1800--2000 (\textbf{35\%})
\vfill
\item 4 Lab Tests during tutorials (\textbf{10\%} each for a total \textbf{40\%})
\end{itemize}
\end{frame}

\begin{frame}{Lab Tests}
\bbullet Held during tutorials on 23 Sept, 07 Oct, 28 Oct, 02 Dec
\vfill
...
\begin{frame}{In Lab Tests/midterm/final..}
\begin{itemize}
...
```\end{lstlisting}
\vfill
I recommend that you play with the \code{echo = } option. Set it to \code{FALSE} and judge your verbosity... Are you explaining enough with the code (and your comments) not shown?
\end{frame}
