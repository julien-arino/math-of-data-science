...
\begin{frame}
\begin{center}
\includegraphics[width=0.45\textwidth]{FIGS/L17-make-trees-1.pdf}
\quad
\includegraphics[width=0.45\textwidth]{FIGS/L17-make-trees-2.pdf}
\end{center}
\end{frame}
...
\maxFrameImage{FIGS/L17-minimal-spanning-tree-Karate-graph-1.pdf}
