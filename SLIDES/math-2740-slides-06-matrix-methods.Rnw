...
<<plot-hockey-1,echo=FALSE,fig.show='hold'>>=
...
\begin{frame}[fragile]
<<plot-hockey-2,echo=FALSE,fig.show='asis'>>=
plot(data$height, data$weight,
    pch = 19, col = "dodgerblue4",
    xlab = "Height (cm)", ylab = "Weight (kg)")
@
...
<<plot-hockey-centred,echo=1:2,fig.show='asis'>>=
...
<<plot-hockey-centred-evector,fig.show='asis'>>=
plot(data$height.c, data$weight.c,
    pch = 19, col = "dodgerblue4",
    xlab = "Height (cm)", ylab = "Weight (kg)")
...
\begin{frame}[fragile]\frametitle{Principal components}
<<plot-hockey-centred-evector-2,echo=FALSE,fig.show='asis'>>=
...
<<plot-hockey-centred-rotated,fig.show='asis'>>=
plot(data$height.c_r, data$weight.c_r,
    pch = 19, col = "dodgerblue4",
    xlab = "x-axis", ylab = "y-axis",
...
<<plot-hockey-centred-evector-3,fig.show='asis'>>=
