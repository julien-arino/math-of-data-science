...
<<plot-old-Canada-census-data>>=
plot(data_old$Year, data_old$Canada,
    type = "b", lwd = 2,
    main = "Canada population 1851-1976",
...
\maxFrameImage{\Sexpr{knitr::fig_chunk("plot-old-Canada-census-data", "pdf")}}
...
<<plot-whole-Canada-census-data,echo=FALSE>>=
plot(data$year, data$population,
    type = "b", lwd = 2,
    main = "Canada population 1851-2011",
    xlab = "Year", ylab = "Population")
@

\maxFrameImage{\Sexpr{knitr::fig_chunk("plot-whole-Canada-census-data", "pdf")}}
