...
\subtitle{MATH 2740 -- Mathematics of Data Science -- Lecture 19}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\titlepagewithfigure{FIGS-slides-admin/a_robot_using_an_easel_to_paint_a_desolate_tree_in_the_style_of_HR_Giger.png}
\outlinepage{FIGS-slides-admin/a_robot_looking_at_a_desolate_tree_as_if_they_were_about_to_paint_the_tree.png}
...
\newSectionSlide{FIGS-slides-admin/a_robot_looking_at_a_desolate_tree_in_the_style_of_Dali.png}
...
\newSubSectionSlide{FIGS-slides-admin/Gemini_Generated_Image_ga57rcga57rcga57.jpeg}
