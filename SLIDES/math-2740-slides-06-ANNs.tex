...
\hlkwd{plot}\hldef{(nn_OR)}
\hldef{pred} \hlkwb{=} \hlkwd{predict}\hldef{(nn_OR, OR_table)}
\hldef{OR_table}\hlopt{$}\hldef{result} \hlkwb{=} \hldef{pred[,}\hlnum{1}\hldef{]} \hlopt{>} \hlnum{0.5}
\hlkwd{kable}\hldef{(OR_table,} \hlsng{"latex"}\hldef{)}
\end{alltt}
\end{kframe}
...
\hldef{nn_XOR} \hlkwb{=} \hlkwd{neuralnet}\hldef{(XOR} \hlopt{~} \hldef{x1} \hlopt{+} \hldef{x2,}
                   ...
                   \hlkwc{hidden} \hldef{=} \hlnum{0}\hldef{,}
                   \hlkwc{linear.output} \hldef{=} \hlnum{FALSE}\hldef{)}
\hlkwd{plot}\hldef{(nn_XOR)}
\hldef{pred} \hlkwb{=} \hlkwd{predict}\hldef{(nn_XOR, XOR_table)}
\hldef{XOR_table}\hlopt{$}\hldef{result} \hlkwb{=} \hldef{pred[,}\hlnum{1}\hldef{]} \hlopt{>} \hlnum{0.5}
\hlkwd{kable}\hldef{(XOR_table,} \hlsng{"latex"}\hldef{)}
\end{alltt}
\end{kframe}
\begin{tabular}{r|r|r|l}
\hline
